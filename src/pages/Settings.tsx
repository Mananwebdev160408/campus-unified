...
const connectedAccounts: ConnectedAccount[] = [
  { id: 'github', name: 'GitHub', icon: Github, connected: true, username: 'alexjohnson' },
  { id: 'linkedin', name: 'LinkedIn', icon: Linkedin, connected: true, username: 'alex-johnson' },
            ...
            <div className="card-elevated p-6">
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <Input defaultValue="STU2021001" disabled className="mt-1 bg-muted" />
                </div>
                <div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <Input defaultValue="Computer Science & Engineering" disabled className="mt-1 bg-muted" />
                </div>
              </div>

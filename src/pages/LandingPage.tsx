  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        >
          <motion.div variants={item} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/10 border border-accent/20 text-sm text-accent mb-6">
            <Zap className="w-4 h-4" />
            Trusted by 500+ institutions worldwide
          </motion.div>
          
          <motion.h1 variants={item} className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground leading-tight max-w-4xl mx-auto">
            The Complete ERP Solution for
            <span className="text-gradient"> Modern Education</span>
          </motion.h1>
          
          <motion.p variants={item} className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
            Streamline student management, academics, placements, and administration with our comprehensive platform designed for universities and colleges.
          </motion.p>
          ...
          <motion.div variants={item} className="mt-12 flex items-center justify-center gap-8 text-sm text-muted-foreground">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
              From admissions to placements, our platform covers every aspect of institutional management.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: 'Comprehensive student profiles with academic history, documents, and attendance tracking.',
                color: 'bg-accent/10 text-accent',
              },
              {
                icon: BookOpen,
                title: 'Academic Management',
                description: 'Course catalog, timetable scheduling, curriculum management, and examination handling.',
                color: 'bg-success/10 text-success',
              },
              {
                icon: ClipboardCheck,
                title: 'Attendance Tracking',
                description: 'Biometric & QR-based attendance with threshold alerts and detailed reports.',
                color: 'bg-warning/10 text-warning',
              },
              {
                icon: BarChart3,
                title: 'Examinations & Grades',
                description: 'Gradebook management, GPA calculations, and secure transcript generation.',
                color: 'bg-primary/10 text-primary',
              },
              {
                icon: Briefcase,
                title: 'Placement Portal',
                description: 'Job postings, AI-powered resume analyzer, and recruiter management.',
                color: 'bg-destructive/10 text-destructive',
              },
              {
                icon: FileText,
                title: 'Resume Builder',
                description: 'Auto-generate verified resumes with QR codes for recruiter verification.',
                color: 'bg-accent/10 text-accent',
              },
            ].map((feature, i) => (
              <motion.div
            ...
            {[
              {
                ...
                description: 'Enter your organization name and get verified instantly through our automated system.',
              },
              {
                step: '02',
                title: 'Set Up Your Portal',
                description: 'Configure departments, courses, and user roles. Import existing student data easily.',
              },
              {
                step: '03',
                title: 'Go Live',
                description: 'Invite students, faculty, and staff. Start managing your institution efficiently.',
              },
            ].map((step, i) => (
              <motion.div
                key={step.step}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              {
                quote: "The most intuitive ERP we've ever used. Our faculty adopted it within days, not months like previous systems.",
                author: "Prof. James Wilson",
                role: "HOD, Cambridge Business School",
                rating: 5,
              },
              {
                quote: "Attendance tracking, fee management, and academic records - all in one place. It's exactly what modern education needs.",
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <span className="text-sm font-medium text-primary-foreground/70">Security First</span>
              <h2 className="text-3xl sm:text-4xl font-bold mt-2 mb-6">
                Enterprise-Grade Security for Your Institution
              </h2>
              <p className="text-primary-foreground/70 mb-8">
                Your data is protected with military-grade encryption, regular backups, and compliance with global education data standards.
              </p>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground mb-10 max-w-2xl mx-auto">
            Join 500+ institutions already using UniERP to streamline their operations and improve student outcomes.
          </p>
